...
public:
	...
	///<summary>
	/// Creates a basic diamond centered in the origin
	///</summary>
	MeshData CreateDiamond(float radius, float height);
	...
	///Create a pyramid
	///</summary>
	MeshData CreatePyramid(float width, float depth, float topWidth, float topDepth, float height, uint32 numSubdivisions);
